...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            if (edtUsername!="saitin"){
                Toast.makeText(this, "Username anda benar", Toast.LENGTH_SHORT).show()
            }else
                if (edtPass!="saitin17"){
                    Toast.makeText(this, "Password anda benar", Toast.LENGTH_SHORT).show()
        ...
        tvRegis.setOnClickListener{
            intent = Intent(this, ActivityRegister2::class.java)
            startActivity(intent)
        }
    }
}
